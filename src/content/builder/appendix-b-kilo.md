...
[Kilo Code](https://kilo.ai) ([Kilo-Org/kilocode](https://github.com/kilo-org/kilocode)) is an open-source agentic coding platform — VS Code extension, JetBrains extension, and CLI. As of the April 2026 snapshot used for this handbook, it is one of the most widely used model-agnostic coding agents in production workflows.
...
System prompt assembly:
  ...
  - Session context
      │
      ▼
LLM call (your chosen model from a large provider catalog)
      │
      ▼
...
Now `/verify-chapter src/content/builder/04-openclaw-architecture.md` runs a full fact-check as a subtask. This is how the source-code verification in this handbook was done systematically.
...
## The Model Strategy — Large Model Catalog, One Interface
...
|--------|-----------|-------------|-------|----------|
| Model-agnostic | ✅ Large provider catalog | ❌ Claude only | ✅ | ✅ |
...
| Ecosystem size (Apr 2026 snapshot) | Strong and growing | — | Very large | Very large |
