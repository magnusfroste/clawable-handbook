...
| **Harness** | The industry's 2026 term for the scaffolding that turns a model into an agent — the loop, tool dispatch, permissions, context management, memory, tracing. What this handbook calls the **control plane** (chapter 5). OpenClaw is a general-purpose harness; FlowPilot's heartbeat loop is an embedded one. |
