...
If only 25-30 relevant skills are in the prompt instead of 109, the LLM has fewer names to confuse. The intent scorer (see [Chapter 17](/builder/17-intent-scoring)) reduces hallucination by reducing the surface area for confusion.
...
*Next: running a swarm of autonomous agents on your own infrastructure. [ClawStack →](/builder/33-clawstack)*
