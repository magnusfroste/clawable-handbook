...
| [Effective harnesses for long-running agents](https://www.anthropic.com/engineering/effective-harnesses-for-long-running-agents) (Anthropic Engineering, Nov 2025) | Claude Agent SDK described as "a powerful, general-purpose agent harness"; compaction, clean state handoffs, incremental scaffolding (ch 5 harness section) | ✅ primary source |
| [Claude Code's source code appears to have leaked](https://venturebeat.com/technology/claude-codes-source-code-appears-to-have-leaked-heres-what-we-know) (VentureBeat, Apr 2026); [The Hacker News](https://thehackernews.com/2026/04/claude-code-tleaked-via-npm-packaging.html) | Mar 31, 2026 npm packaging error exposed ~513K lines of unobfuscated TypeScript — the harness laid bare (ch 5) | ✅ multi-outlet coverage |
...
| [Antigravity vs Codex: agent-first IDE vs cloud coding agent](https://www.eigent.ai/blog/antigravity-vs-codex); [XDA month-long comparison vs Claude Code](https://www.xda-developers.com/used-claude-code-google-antigravity-codex-for-month-have-clear-winner/); [WeavAI: Antigravity 2.0 review](https://weavai.app/blog/en/2026/05/22/google-antigravity-2-0-vs-openai-codex-2026-review/) | Codex standalone macOS app (Feb 2026), async task→PR model; Antigravity launched with Gemini 3 (Nov 2025), 2.0 adds parallel agents + CLI | ✅ Multiple outlets |
