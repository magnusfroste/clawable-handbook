...
*Next: when multiple heartbeats run simultaneously — how to prevent agents from colliding and how to see inside them when things go wrong. [Concurrency & Observability →](/builder/11-concurrency-observability)*
