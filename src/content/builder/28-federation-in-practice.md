...
Enter ClawOne — an OpenClaw instance running on ClawClass (today AgentHotel), configured as a QA specialist.
...
This is stagnation detection (see [Chapter 21](/builder/21-stagnation-and-drift)) performed by an external agent rather than an internal heuristic. The external perspective matters — FlowPilot might rationalize its own inaction.
...
*Next: securing agentic systems — threat surfaces, guardrails, and production security patterns. [Security →](/builder/29-security)*
