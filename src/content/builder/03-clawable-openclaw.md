...
│  A2A plugin enabled             68 modules · 500+ skills│
│  ──────────────────            ─────────────────────────│
...
| **MCP** | Streamable HTTP | External developer access — the shared 500+ skill catalog via Cursor, Claude Desktop |
...
Once this worked with one QA Claw, the natural next step was to add more specialist roles: SEO Claw, Dev Claw, Research Claw. That is where infrastructure friction emerged — which is exactly why the fleet infrastructure in chapter 33 — first ClawClass, today AgentHotel — exists.
