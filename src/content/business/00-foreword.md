...
Late in 2024 the signal arrived, the way it always does — quietly, and dismissed as a toy. Meta had just shipped a family of small open-weights models built to run on phones and laptops, and I downloaded one onto my own Mac. Getting it to run locally was an engineering project. What it did once it ran was not.

At a children's birthday party, a quantitative analyst at a major bank sat down with my laptop while the kids played. He put his hardest questions to it — the mathematical and statistical models he worked with daily — and watched concepts get explained in a way no course and no teacher had managed. Everything he had been meaning to look up and never gotten around to, answered in minutes. He asked how this was possible: the collected knowledge, the reasoning, could not possibly be *on the laptop*. I showed him the Wi-Fi was off. Then it had to be enormous — hundreds of gigabytes? I showed him the folder where the weights lived: **one and a half gigabytes.** He went quiet the way people do when a mental model breaks. That day, a 1.5-gigabyte file from Meta became a signal that something large was about to happen.
