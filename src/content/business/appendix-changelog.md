...
- **The folder on the laptop** (foreword, *Why I Built This*): the author's origin note now says what he actually saw in early 2024 — Meta's open weights running locally on his own Mac, back when that still meant compile, convert, quantize — and a quantitative analyst at a major bank putting his hardest questions to it at a children's birthday party. The Wi-Fi was off. The weights were about a hundred times smaller than the analyst guessed. By 2025 the shape had appeared in full: models that could act, not just answer. Written without a model version or file size on purpose: the author remembers the moment, not the megabytes, and the book does not print numbers it cannot stand behind. The gap between the guess and the folder is the evidence, and it is his own.
