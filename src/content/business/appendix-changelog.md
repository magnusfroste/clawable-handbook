...
- **"The Labs Came From the Other Side"** (ch 7): Anthropic's Claude Code/Cowork, OpenAI's Codex, and Google's Antigravity — all three frontier labs now ship their own agent layer, and agentic capability is folding into the everyday chat clients. Why that doubles the operator decision rather than replacing it: the personal agent surface vs. the standing business operator, and the two budget lines a CFO should keep apart.
