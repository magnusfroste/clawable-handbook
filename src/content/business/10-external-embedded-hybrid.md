...
The orchestrator handles the intelligence. The native agents handle the execution. Every delegation is logged, auditable, and reversible. Nothing happens in the dark.
